...
def cadastrarclientes():
    ...
    validacao_data = janelaclientes.register(validar_data)
    font=("Comic Sans MS",20)
    
    
    frameauxiliar = tk.Frame(janelaclientes, bg="#c8dbde")
    frameauxiliar.pack(expand=True)
    framedotitulo= tk.Frame(frameauxiliar, bg="#c8dbde")
    framedotitulo.pack()

    titulo = tk.Label(framedotitulo, text="Cadastro de Clientes", font=("Comic Sans MS", 30, "bold"), background="#c8dbde")
    titulo.pack()
    
    frame = tk.Frame(frameauxiliar, bg="#c8dbde")
    frame.pack(side="left",padx=50)

    frame2= tk.Frame(frameauxiliar, bg="#c8dbde")
    frame2.pack(side="left",padx=10)

    idprint = tk.Label(frame, text="Id do Cliente", font=font, background='#c8dbde')
    idprint.pack(pady=10)
    idclientes = tk.Entry(frame, font=font, validate="key", validatecommand=(validacao, "%P"))
    idclientes.pack()

    nomeprint = tk.Label(frame, text="Nome", font=font, background='#c8dbde')
    nomeprint.pack(pady=10)
    nome = tk.Entry(frame, font=font)
    nome.pack()

    cpfprint = tk.Label(frame, text="CPF", font=font, background='#c8dbde')
    cpfprint.pack(pady=10)
    cpf = tk.Entry(frame, font=font, validate="key", validatecommand=(validacao, "%P"))
    cpf.pack()

    datainprint = tk.Label(frame, text="Data Check-IN", font=font, background='#c8dbde')
    datainprint.pack(pady=10)
    datain = tk.Entry(frame, font=font,validate="key", validatecommand=(validacao_data, "%P"))
    datain.pack()

    dataoutprint = tk.Label(frame, text="Data Check-Out", font=font, background='#c8dbde')
    dataoutprint.pack(pady=10)
    dataout = tk.Entry(frame, font=font, validate="key", validatecommand=(validacao_data, "%P"))
    dataout.pack()

    telefoneprint = tk.Label(frame2, text="Telefone", font=font, background='#c8dbde')
    telefoneprint.pack(pady=10)
    telefone = tk.Entry(frame2, font=font, validate="key", validatecommand=(validacao, "%P"))
    telefone.pack()

    emailprint = tk.Label(frame2, text="E-mail", font=font, background='#c8dbde')
    emailprint.pack(pady=10)
    email = tk.Entry(frame2, font=font)
    email.pack()

    estadoprint = tk.Label(frame2, text="Estado", font=font, background='#c8dbde')
    estadoprint.pack(pady=10)
    estado = tk.Entry(frame2, font=font)
    estado.pack()

    cidadeprint = tk.Label(frame2, text="Cidade", font=font, background='#c8dbde')
    cidadeprint.pack(pady=10)
    cidade = tk.Entry(frame2, font=font)
    cidade.pack()

    quartoprint = tk.Label(frame2, text="Número do Quarto", font=font, background='#c8dbde')
    quartoprint.pack(pady=10)
    quarto = tk.Entry(frame2, font=font, validate="key", validatecommand=(validacao, "%P"))
    quarto.pack()

    frame_botoes = tk.Frame(frameauxiliar, bg="#c8dbde")
    frame_botoes.pack(padx=50,side="left",pady=30)
    ...
    botaocadastro.pack(side="top", pady=20)
    ...
    botaovoltar.pack(side="top", pady=20)
    mensagem = tk.Label(frame_botoes, text="", font=font, background="#c8dbde", fg="blue")
    mensagem.pack(pady=10,side="top")
...
def cadastrarfuncionarios():
    ...
    frameauxiliar = tk.Frame(janelafuncionarios, bg="#c8dbde")
    frameauxiliar.pack(expand=True)
    framedotitulo= tk.Frame(frameauxiliar, bg="#c8dbde")
    framedotitulo.pack()

    titulo = tk.Label(framedotitulo, text="Cadastro de Funcionários", font=("Comic Sans MS", 30, "bold"), background="#c8dbde")
    titulo.pack()
    ...
    idprint = tk.Label(frame, text="Id do Funcionário", font=font, background='#c8dbde')
    idprint.pack(pady=10)
    idfuncionarios = tk.Entry(frame, font=font, validate="key", validatecommand=(validacao, "%P"))
    idfuncionarios.pack()
    ...
    telefoneprint = tk.Label(frame, text="Telefone", font=font, background='#c8dbde')
    telefoneprint.pack(pady=10)
    telefone = tk.Entry(frame, font=font, validate="key", validatecommand=(validacao, "%P"))
    telefone.pack()

    emailprint = tk.Label(frame, text="E-mail", font=font, background='#c8dbde')
    emailprint.pack(pady=10)
    email = tk.Entry(frame, font=font)
    email.pack()
    ...
    cargoprint = tk.Label(frame2, text="Cargo", font=font, background='#c8dbde')
    cargoprint.pack(pady=10)
    cargo = tk.Entry(frame2, font=font)
    cargo.pack()

    cargahorariaprint = tk.Label(frame2, text="Carga Horária", font=font, background='#c8dbde')
    cargahorariaprint.pack(pady=10)
    cargahoraria= tk.Entry(frame2, font=font, validate="key", validatecommand=(validacao, "%P"))
    cargahoraria.pack()

    turnoprint = tk.Label(frame2, text="Turno", font=font, background='#c8dbde')
    turnoprint.pack(pady=10)
    turno = tk.Entry(frame2, font=font)
    turno.pack()   
    ...
    botaocadastro.pack(side="top", padx=20,pady=20)
    ...
    botaovoltar.pack(side="top", padx=20)
